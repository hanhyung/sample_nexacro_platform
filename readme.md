...
!Latest release(https://img.shields.io/badge/Nexacro%20Platform-v14.0.0.901-blue.svg)
...
주의사항
---------
넥사크로스튜디오에서 프로젝트 파일, 테마 파일, 설정관련 파일없이 단독으로 xfdl 파일만 수행했을 경우에는 디자인 및 정보관련 에러가 발생할 수 있습니다. 이러한 에러는 샘플의 동작에 지장을 주지 않습니다.
